...
export default function Page() {
  return (
    <section>
      ...
      <p className="mb-6">
        I am a 3rd year undergraduate student studying Computer Science at <a href={ucdavis} target="_blank" className="link">UC Davis</a>. 
      </p>
      <p className="mb-6">
        I have a strong passion for getting a job. Add another sentence here about your interests or drive or passion.
      </p>
      <p className="mb-6">
        Currently, I work at <a href={aggieworks} target="_blank" className="link">AggieWorks</a>. I also do ______________ at <a href={asa} target="_blank" className="link">Aggie Sports Analytics</a>.
      </p>
